...
explicit requirements:
  -the amount of norths must also be equal to the amount of wests 
  -
  -
datastructures
input: //
...
algorithm
get the uniq values from the array and iterate over them
  sort
=end
def is_valid_walk(walk)
  return true if walk.size == 10 && walk.count('n') == walk.count('s') &&
